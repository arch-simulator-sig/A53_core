...
Vrvcpu::Vrvcpu(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , vlSymsp{new Vrvcpu__Syms(contextp(), _vcname__, this)}
    , clk{vlSymsp->TOP.clk}
    , rst{vlSymsp->TOP.rst}
...
Vrvcpu::Vrvcpu(const char* _vcname__)
    : Vrvcpu(Verilated::threadContextp(), _vcname__)
{
}
...
#endif  // VL_DEBUG
void Vrvcpu___024root___eval_static(Vrvcpu___024root* vlSelf);
...
void Vrvcpu::eval_step() {
    ...
    if (VL_UNLIKELY(!vlSymsp->__Vm_didInit)) {
        ...
        Vrvcpu___024root___eval_static(&(vlSymsp->TOP));
...
//============================================================
// Events and timing
bool Vrvcpu::eventsPending() { return false; }

uint64_t Vrvcpu::nextTimeSlot() {
...
void Vrvcpu___024root___eval_final(Vrvcpu___024root* vlSelf);

VL_ATTR_COLD void Vrvcpu::final() {
    Vrvcpu___024root___eval_final(&(vlSymsp->TOP));
}

//============================================================
// Implementations of abstract methods from VerilatedModel

const char* Vrvcpu::hierName() const { return vlSymsp->name(); }
const char* Vrvcpu::modelName() const { return "Vrvcpu"; }
unsigned Vrvcpu::threads() const { return 1; }
std::unique_ptr<VerilatedTraceConfig> Vrvcpu::traceConfig() const {
...
VL_ATTR_COLD void Vrvcpu::trace(VerilatedVcdC* tfp, int levels, int options) {
    if (tfp->isOpen()) {
        vl_fatal(__FILE__, __LINE__, __FILE__,"'Vrvcpu::trace()' shall not be called after 'VerilatedVcdC::open()'.");
    }
